...
<div id="wrapper">
												...
												<div class="row show-grid">
												    <div class="col-lg-12">
														<h3 class="page-header">
													   	 存储设备状态查询 <small></small>
														</h3>
														<ol class="breadcrumb">
													    	<li class="active">
																<i class="fa fa-table"></i> 存储设备状态曲线图						
													    	</li>
															</ol>
								...
								<div  id="canvasGrandP "style="width:100%;">
                                 ...
                                 <div style="width:100%;">
                                          ...
                                          <div id="lineLegend1" style="margin-left: 25px"></div>
                                                      <input type="button"  style="float: right" onclick="nextOneHour()" value="后6小时"/>	
                                                      <input type="button"  style="float: right;margin-right:10px" onclick="lastOneHour()" value="前6小时"/>
   ...
   <script type="text/javascript" src="<%=basePath %>static/js/esm-main-legend.js"></script>
	<script type="text/javascript" src="<%=basePath %>static/js/esm-seekstor-line.js"></script>
