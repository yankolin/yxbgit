...
$(function() {
    ...
    $('.pie-chart-tiny1').easyPieChart({
        ...
        animate: 3000,
        onStep: function(from, to, percent) {
            $(this.el).find('.percent1').text((percent*10).toFixed(2));
            $(this.el).find('.percent2').text((percent*10).toFixed(2));
            $(this.el).find('.percent3').text((percent*10).toFixed(2));
            $(this.el).find('.percent4').text((percent*10).toFixed(2));
        }
    });

    var chart = window.chart = $('.pie-chart-tiny1').data('easyPieChart');
    $('.pie-chart-tiny1 .pie-title > i').on('click', function() {
        $(this).closest('.pie-chart-tiny1').data('easyPieChart').update(Math.random()*200-100);
    });
});