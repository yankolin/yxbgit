...
<body onload="init();">
	<div
		style="background-image: url(<%=basePath%>static/img/back-login.jpeg);width:1920px;height:1280px">
		<div id="loginBody">
			<form class="form-horizontal" role="form" method="post"
				action="doLogin" onSubmit="return validate();">
				<div id="header" class="form-control"
					style="height: 80px; background-color: transparent; border: none">
				...
				<div class="form-group">
					...
					<div class="col-sm-7 ">
						<input type="password" class="form-control" id="admin_pwd"
							name="admin_pwd" placeholder="请输入密码" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<label for="admin3" id="admin_check_text" class="control-label"></label>
						<a href="javascript:void(0)" onclick="changDiscode()"
							style="color: #1589c9;">换一张</a>
					</div>
				</div>
				<div class="form-control"
					style="background-color: whitesmoke; height: 40px; text-align: center; border: none">
					<span id="admin_error"
						style="text-align: center; color: red; border: none">${ error_login }</span>
				</div>
				<div class="form-group">
	...
	<script type="text/javascript"
		src="<%=basePath%>static/js/jquery-1.12.2.min.js"></script>
	<script type="text/javascript"
		src="<%=basePath%>static/js/esm-login.js"></script>
